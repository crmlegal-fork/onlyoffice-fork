...
echo "  sudo certbot --nginx -d editor.embitech.cloud --non-interactive --agree-tos -m TU_EMAIL@embitech.es"
echo "  sudo nginx -t && sudo systemctl reload nginx"
echo ""
echo "Tras eso, probar:"
echo "  curl -fsS https://editor.embitech.cloud/healthcheck  → 'true'"
echo "================================================================"
